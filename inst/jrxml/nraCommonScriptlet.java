...
public class nraCommonScriptletRPackage extends JRDefaultScriptlet {
	...
	private void generateReport() {
		try {
			log.info("Start generating R report using " + nraCommonScriptletRPackage.class.getName());
			
			//TODO
			// Make log entry if class is built as a snapshot. SET MANUALLY!
			boolean classIsSnapshot = false;
			if (classIsSnapshot) {
				log.warn(nraCommonScriptletRPackage.class.getName() + " is a snapshot. Not to be used in production environment");
			}
