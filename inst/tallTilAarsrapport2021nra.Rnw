...
skriftStr=2.0
pktStr=1.5
figfolder <- "~/.ssh/nra/aarsrapp_2021/"
...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}WexnerMindreEnn9_snm_5aar.pdf}
% \caption{Andel Wexner mindre enn 9, snm, 5-årsoppfølging}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}WexnerMindreEnn9_sfinkt_5aar.pdf}
% \caption{Andel Wexner mindre enn 9, sfinkter, 5-årsoppfølging}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}WexnerMindreEnn12_snm_5aar.pdf}
% \caption{Andel Wexner mindre enn 12, snm, 5-årsoppfølging}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}WexnerMindreEnn12_sfinkt_5aar.pdf}
...
# outfile <- paste0(figfolder, "StMarksTotalScore_snm_elektrode.pdf")
...
# outfile <- paste0(figfolder, "QolSexualitet_sfinkt.pdf")
...
# }
#
# outfile <- paste0(figfolder, "QolSexualitet_snm.pdf")
# nraGjsnPrePost(RegData, valgtVar='QolSexualitet', datoFra=datoFra, datoTil=datoTil,
#                outfile = outfile, preprosess=preprosess, minald=minald, maxald=maxald,
#                erMann=erMann, reshID=reshID, hentData=hentData, forlopstype1=2, forlopstype2=forlopstype2,
#                sammenlign=1, inkl_konf=1)
...
# }
#
# outfile <- paste0(figfolder, "QolSexualitet.pdf")
# nraGjsnPrePost(RegData, valgtVar='QolSexualitet', datoFra=datoFra, datoTil=datoTil,
#                outfile = outfile, preprosess=preprosess, minald=minald, maxald=maxald,
...
# outfile <- paste0(figfolder, "GenQol_sfinkt.pdf")
...
# }
#
# outfile <- paste0(figfolder, "GenQol_samlet.pdf")
# nraGjsnPrePost(RegData, valgtVar='GenQol', datoFra=datoFra, datoTil=datoTil,
#                outfile = outfile, preprosess=preprosess, minald=minald, maxald=maxald,
#                erMann=erMann, reshID=reshID, hentData=hentData, forlopstype1=forlopstype1, forlopstype2=forlopstype2,
#                sammenlign=1, inkl_konf=1)
...
#
#
# outfile <- paste0(figfolder, "Tilfredshet_gr_snm.pdf")
# nraGjsnGrVar(RegData, valgtVar='Tilfredshet', datoFra=datoFra, datoTil=datoTil,
#              outfile = outfile, preprosess=preprosess, minald=minald, maxald=maxald, decreasing=decreasing,
...
# }
#
# outfile <- paste0(figfolder, "Tilfredshet_gr_sfinkt.pdf")
# nraGjsnGrVar(RegData, valgtVar='Tilfredshet', datoFra=datoFra, datoTil=datoTil,
#              outfile = outfile, preprosess=preprosess, minald=minald, maxald=maxald, decreasing=decreasing,
