...
RegData <- read.table('I:/nra/alleVarNum2019-06-14 13-34-56.txt', header=TRUE, sep=";", encoding = 'UTF-8')
...
ForlopData <- read.table('I:/nra/ForlopsOversikt2019-06-14 13-34-54.txt', header=TRUE, sep=";", encoding = 'UTF-8')
