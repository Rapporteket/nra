...
\title{Figurer og tabeller til årsrapport for NRA 2019}
\author{NRA}
...
RegData <- read.table('I:/nra/alleVarNum2020-05-05 16-04-20.txt', header=TRUE, sep=";", encoding = 'UTF-8')
...
ForlopData <- read.table('I:/nra/ForlopsOversikt2020-05-05 16-04-20.txt', header=TRUE, sep=";", encoding = 'UTF-8')
...
erMann <- 99
datoFra <- '2019-01-01'	 # min og max dato i utvalget vises alltid i figuren.
datoTil <- '2019-12-31'
