...
RegData <- read.table('I:/nra/alleVarNum2020-09-04 15-00-46.txt', header=TRUE, sep=";", encoding = 'UTF-8')
...
ForlopData <- read.table('I:/nra/ForlopsOversikt2020-09-04 15-00-46.txt', header=TRUE, sep=";", encoding = 'UTF-8')
