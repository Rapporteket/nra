...
nraFigAndelTid  <- function(RegData, valgtVar, datoFra='2012-04-01', datoTil='2050-12-31',
                           valgtShus='', outfile = '', minald=0, maxald=130, tidsenhet="Kvartal",
                           erMann=99, reshID, enhetsUtvalg=0, hentData=F, forlopstype1=99,
                           forlopstype2=99, onestage=99, inkl_konf=FALSE) {
